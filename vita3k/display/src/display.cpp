...
#include <display/functions.h> // Keep this include - it's where the declaration is
...
// CRITICAL FIX: Added missing standard library headers
#include <atomic>   // For std::atomic
#include <chrono>   // For std::chrono
#include <mutex>    // For std::mutex
#include <deque>    // For std::deque
#include <cmath>    // For std::sqrt
#include <thread>   // For std::this_thread::sleep_for and std::this_thread::yield
